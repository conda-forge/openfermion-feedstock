...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openfermion-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14674&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openfermion-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openfermion` can be installed with:

```
conda install openfermion
```

It is possible to list all of the versions of `openfermion` available on your platform with:
